...
<p align="center"> 
  ...
  <p align="center"><font face="Verdana" size="4" color="#666699">You can contact 
    us by updating our message board. Type your details and the message then click 
    on the 'send message' button. Once we have verified the message it will appear 
    lower down on this page.</font></p>
<p align="center">&nbsp;</p>
  <div align="right">
    <table width="50%" border="0" align="center" bordercolor="#666699">
      ...
      <tr> 
		...
		$subjectsListResult = DB($query,"john2land");
...
<?php
	...
	while($count > 0)
	{
		...
		$subjectResult = DB($query,"john2land");
